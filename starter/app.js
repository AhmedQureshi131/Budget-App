...
Expense.prototype.getPercentage = function(){
  ...
  return {
    addItem: function (type, des, val) {
      ...
      //now store this into the data object
      //and push in into our data structure
...
var UIController = (function () {
  ...
  //wrtie a method to get the ui data
  //so we need a public function so it should be an object
  var formatNumber = function(num, type){
    /*
    + or - befor number
    exactly 2 decimal oints
...
var nodeListForEach = function(list, callback){
  ...
  return {
    getInput: function () {
      return {
        //read the data now from UI interface
...
var controller = (function (budgetCtrl, UICtrl) {
  //function in which all the variables place
  var setupEventlisteners = function () {
    var DOM = UICtrl.getDOMstring();
    document.querySelector(DOM.inputBtn).addEventListener("click", ctrlAddItem);

    //Other event listener for return key press(ENTER)
  ...
  var ctrlAddItem = function () {
    ...
    if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
      ...
      //Add the new item to the user interface as well
